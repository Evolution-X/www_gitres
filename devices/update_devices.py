...
def main():
    ...
    for device in devices_json:
        output_path = f"images/{device}.webp"
        ...
        if not os.path.exists(output_path):
            ...
            if image_response.status_code == 200:
                print(f"\033[93m[WARNING]\033[0m {device}.webp does not exist locally.")
                ...
                print(f"\033[93m[WARNING]\033[0m {device}.png is not available on the LineageOS GitHub.")
